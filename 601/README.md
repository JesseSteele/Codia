...
## Prerequisite: [Linux 401](https://github.com/JesseSteele/Codia/tree/master/401)

While this course comes after [Linux 501](https://github.com/JesseSteele/Codia/tree/master/501), it is not a prerequesite. However, it is recommended to complete [Linux 501](https://github.com/JesseSteele/Codia/tree/master/501) first so that a System Administrator can understand what a Linux server might be used for

### [Lesson 0: POSIX & Lesson Layout](https://github.com/JesseSteele/Codia/blob/master/601/Lesson-00.md)
