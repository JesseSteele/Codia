...
- boolean *- only `true` or `false`*
  ...
  - ***Boolean only allows TWO values, `exit`/error/`return` codes have many more!***
    - `return` codes covered in in [Linux 401 Lesson 10](https://github.com/JesseSteele/Codia/blob/master/401/Lesson-10.md)
  - Review `exit` codes (which are different) in [Linux 301 Lesson 6](https://github.com/JesseSteele/Codia/blob/master/301/Lesson-06.md)
...
#### [Lesson 7: More with while & sed](https://github.com/JesseSteele/Codia/blob/master/401/Lesson-07.md)
